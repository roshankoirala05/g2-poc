...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <liclass ="active"><a href="#">Add visitor</a></li>
    </ul>
  </div>
</nav> 
<div class = "container" >
...
<form class="well form-horizontal" action="addvisitor.php" method="post" id="contact_form">
                <fieldset>
                    ...
                    <!-- Form Name -->
                    <legend>Please fill and submit the form</legend>
                            ...
                            <ul class="firstrow">
                                <li>
                                    <div class="radio-inline">
                                        <label>
                                            <input type="radio" name="TravelingFor" value="business" /> Business
                                        </label>
                                    </div>
                                </li>
                                <li>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="radio-inline">
                                <label>
                                    <input type="radio" name="HowDidYouHear" value="Billboard" /> Billboard
                                </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="radio-inline">
                                <label>
                                    <input type="radio" name="DidYouStay" value="yes" /> Yes
                                </label>
                            </div>
                            <div class="radio-inline">
                                <label>
