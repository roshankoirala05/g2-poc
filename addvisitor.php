<html>
	...
	<body>
		...
		if (!(empty($_POST["countryName"])) || !(empty($_POST["cityName"])) || !(empty($_POST["zipcode"])) || !(empty($_POST["firstName"]))) {
		...
		**************************************************************************************
		...
		<div class = "container" >
			...
			<?php if (!(empty($_POST["countryName"])) || !(empty($_POST["cityName"])) || !(empty($_POST["zipcode"])) || !(empty($_POST["firstName"]))) {
			echo'
			<div class="alert alert-success alert-dismissable fade in">
				<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
				<p align="center" >
					A visitor record has been successfully added to the database
				</p>
			</div>';
			}
			?>
			<form class="well form-horizontal" action="addvisitor.php" method="post" id="contact_form">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-4 inputGroupContainer">
							<div class="input-group">
								...
								<input name="noInParty"  class="form-control" type="text">
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							...
							<div class="radio-inline">
								<label>
									<input type="radio" name="HowDidYouHear" value="Interstate Signs" />
					...
					<div class="col-md-4">
						...
						<div id="floating-pane3">
							<a href="admin.php" class="btn btn-danger btn-lg"><span class="glyphicon glyphicon-step-backward"></span> Return Home </a>
						</div>
					</div>
				</fieldset>
			</form>
