		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					...
					<li>
						<a href="visitor.php?id=<?php echo $visitorId;?>">View</a>
					</li>
					<li>
						<a href="#">Edit</a>
					</li>
		...
		<div class = "container" >
			...
			<form class="well form-horizontal" action="updateVisitor.php?id=<?php echo $id;?>" method="post" id="contact_form">
				<fieldset>
					...
					<!-- Form Name -->
					<legend>
						Please update and submit the form
					</legend>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<ul class="firstrow">
								<li>
									<div class="radio-inline">
										<label>
											<input type="radio" name="TravelingFor" value="business" <?php if ($purpose=='business'){echo 'Checked';}?>/>
											Business </label>
									</div>
								</li>
								<li>
									<div class="radio-inline">
										<label>
											<input type="radio" name="TravelingFor" value="Pleasure" <?php if ($purpose=='Pleasure'){echo 'Checked';}?>/>
											Pleasure </label>
										<br>
									</div>
								</li>
							...
							<div class="radio-inline">
								<label>
									<input type="radio" name="TravelingFor" value="Convention" <?php if ($purpose=='Convention'){echo 'Checked';}?>/>
									Convention </label>
							</div>

							<div class="radio-inline">
								<label>
									<input type="radio" name="TravelingFor" value="Others" <?php if ($purpose=='Others'){echo 'Checked';}?>/>
									Others </label>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="radio-inline">
								<label>
									<input type="radio" name="HowDidYouHear" value="Billboard" <?php if ($hear=='Billboard'){echo 'Checked';}?>/>
									Billboard </label>

							</div>
							<div class="radio-inline">
								<label>
									<input type="radio" name="HowDidYouHear" value="Interstate Signs" <?php if ($hear=='Interstate'){echo 'Checked';}?>/>
							...
							<ul class="firstrow">
								<li>
									<div class="radio-inline">
										<label>
											<input type="radio" name="HowDidYouHear" value="Others" <?php if ($hear=='Others'){echo 'Checked';}?>/>
											Others </label>
									</div>
								</li>
							</ul>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="radio-inline">
								<label>
									<input type="radio" name="DidYouStay" value="yes" <?php if ($hotel=='yes'){echo 'Checked';}?>/>
									Yes </label>
							</div>
							<div class="radio-inline">
								<label>
									<input type="radio" name="DidYouStay" value="no" <?php if ($hotel=='no'){echo 'Checked';}?> />
									No </label>
							</div>
						</div>
					</div>
