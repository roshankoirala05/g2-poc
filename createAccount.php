		...
		<div id="main">
			...
			<div id="Create">
				...
				<form action="createadmin.php" method="post">
					...
					<br />
					<br />
					<input type="username" name="username" id="username" placeholder="Enter your E-mail"required/>
					<br />
					...
					<br />
					<input type="username" name="Answer" id="Answer" placeholder="Please answer here" required />
					<br/>
					<br/>
					<input placeholder="Date of Birth Eg. MM/DD/YYYY" name="bday" class="bday"  onfocus="(this.type='date')" type="bday" id="bday">
					<br/>
					<br/>
					...
					<br />
					<p id="two" >
						Alerady have an account ? <a href="index.php">Login Here</a>
					</p>
				</form>
