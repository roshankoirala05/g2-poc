                ...
                <fieldset>
                    ...
                    <div class="col-md-4">
                        <div id="floating-pane1">
                            <button type="submit" id="finalsubmit" name="finalsubmit"  value="click" class="btn btn-success btn-lg">Submit Registration <span class="glyphicon glyphicon-send"></span>
                            </button>
                        </div>
