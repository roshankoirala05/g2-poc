					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<div class="radio-inline">
									<label>
										<input type="radio" name="TravelingFor" value="business" Checked/>
										Business </label>
								</div>
								<div class="radio-inline">
									<label>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<div class="radio-inline">
									<label>
										<input type="radio" name="HowDidYouHear" value="Billboard" Checked/>
										Billboard </label>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<div class="radio-inline">
									<label>
										<input type="radio" name="DidYouStay" value="yes" Checked/>
										Yes </label>
								</div>
								<div class="radio-inline">
									<label>
						...
						<div class="col-md-4">
							<div id="floating-pane1">
								<button type="submit" id="finalsubmit" name="finalsubmit"  value="click" class="btn btn-success btn-lg">
									Submit Registration <span class="glyphicon glyphicon-send"></span>
								</button>
							</div>
