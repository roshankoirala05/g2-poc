...
FusionCharts.register("module", ["private", "modules.renderer.js-charts", function () {
 ...
 function Ma(a, p, c, d, k, b, s, ca, e, r) {
  ...
  this.bottomBorderGroup = ca.group("bottom-border", s).attr({
   transform: "t0," + b
  });
...
"Z"];
 ...
 var ea = this,
  ...
  Ka = m.document,
  Z = D.BLANKSTRING,
  Xa = D.createTrendLine,
  g = D.pluck,
  wa = D.getValidValue,
  Ia = D.parseTooltext,
  f = D.pluckNumber,
  Ja = D.getFirstValue,
  Ua = D.getDefinedColor,
  oa = D.parseUnsafeString,
  ta = D.FC_CONFIG_STRING,
  xa = D.extend2,
  Ea = D.getDashStyle,
  J = D.toRaphaelColor,
  Na = D.toPrecision,
  ...
  ka = D.hasSVG,
  Aa = D.each,
  ya = D.TOUCH_THRESHOLD_PIXELS,
  Qa = D.CLICK_THRESHOLD_PIXELS,
  za = D.plotEventHandler,
  b = D.hasTouch ? ya : Qa,
  e = "rgba(192,192,192," + (D.isIE ? .002 : 1E-6) + ")",
  h = 8 === m.document.documentMode ? "visible" : "",
  B = Math,
  E = B.sin,
  w = B.cos,
  aa = B.atan2,
  ...
  T = 2 * A,
  Za = A + Ya,
  Ba = D.graphics.getColumnColor,
  da = D.getFirstColor,
  ba = D.setLineHeight,
  Va = D.pluckFontSize,
  Fa = D.getFirstAlpha,
  fa = D.graphics.getDarkColor,
  ma = D.graphics.getLightColor,
  la = D.graphics.convertColor,
  Ra = D.COLOR_TRANSPARENT,
  Wa = D.POSITION_CENTER,
  bb = D.POSITION_TOP,
  $a = D.POSITION_BOTTOM,
  cb = D.POSITION_RIGHT,
  db = D.POSITION_LEFT,
  eb = D.parsexAxisStyles,
  ab = D.hashify,
  n = D.chartAPI,
  Ha = D.graphics.mapSymbolName,
  ya = n.singleseries,
  $ = D.COMMASTRING,
  ra = D.ZEROSTRING,
  Ga = D.ONESTRING,
  ...
  Sa = D.PXSTRING,
  fb = D.COMMASPACE,
  sa = !/fusioncharts\.com$/i.test(m.location.hostname);
 n("column2d", {
  standaloneInit: !0,
 ...
 n("pie2d", {
  ...
  point: function (a, p, c, d, k) {
   ...
   var b = this.colorManager,
    ...
    e = f(ca, s ? .1 : 1),
    r = f(d.enablemultislicing, 1),
    Q = f(d.use3dlighting, 1),
    l = Q ? f(d.radius3d, d["3dradius"], 90) : 100,
    h = f(d.showzeropies, 1),
    B = f(d.showpercentintooltip, 1),
    na = f(d.showlabels,
     1),
    G = f(d.showvalues, 1),
    n = f(d.showpercentvalues, d.showpercentagevalues, 0),
    x = g(d.tooltipsepchar, d.hovercapsepchar, fb),
    gb = g(d.labelsepchar, x),
    ja = g(d.plotbordercolor, d.piebordercolor),
    y = k[ta].numberFormatter,
    w = c.length,
    E = f(d.plotborderdashed, 0),
    M = f(d.plotborderdashlen, 5),
    z = f(d.plotborderdashgap, 4),
    F = f(d.showvalueinlegend, 0),
    P = f(d.showlabelinlegend, 1),
    u = f(d.valuebeforelabelinlegend, 0),
    Ta = f(d.showvalueaspercentinlegend, 1),
    I = f(d.reverseplotorder, 0),
    U = g(d.legendsepchar, ", "),
    W = k.plotOptions.series.dataLabels.style,
    V = 0,
    A = [],
    R, v, S, X, q, Y, C, t, va, O, aa, L, m, N, T, D, K, ha, J, H = -1;
   ...
   for (v = A.length - 1; 0 <= v; --v) {
    ...
    R = {
     label: g((ha = X.centerlabel || d.centerlabel) && this.replaceMacros(ha, ["\\$value", "\\$percentValue", "\\$displayValue", "\\$label"], [L, aa, void 0 === N ? "" : N, R]), ""),
     font: K.font,
  ...
  configureAxis: function (a, p) {
   ...
   if (1 === a.series.length && (ca = a.series[0].data) && 0 < (c = a.series[0].data.length) && a.plotOptions.series.dataLabels.enabled)
    for (; c--;) ca[c] &&
     void 0 !== wa(ca[c].displayValue) && d.push({
  ...
  spaceManager: function (a, p, c, d) {
   var k = a[ta],
    ...
    e = this.smartLabel || k.smartLabel,
    r = f(k.pieDATALabels && k.pieDATALabels.length, 0),
    Q = 0,
    l = p.chart,
    h = f(l.managelabeloverflow, 0),
    B = f(l.slicingdistance),
    na = k.preSliced || l.enableslicing !== ra || l.showlegend === Ga && l.interactivelegend !== ra ? ha(f(B, 20)) : 0,
    G = f(l.pieradius, 0),
    n = f(l.enablesmartlabels, l.enablesmartlabel, 1),
    x = n ? f(l.skipoverlaplabels,
     l.skipoverlaplabel, 1) : 0,
    w = f(l.issmartlineslanted, 1),
    ja = r ? f(l.labeldistance, l.nametbdistance, 5) : na,
    y = f(l.smartlabelclearance, 5);
   c -= a.chart.marginRight + a.chart.marginLeft;
   var E = d - (a.chart.marginTop + a.chart.marginBottom);
   d = t(E, c);
   var u = g(l.smartlinecolor, ca.getColor("plotFillColor")),
    M = f(l.smartlinealpha, 100),
    z = f(l.smartlinethickness, .7),
    F = a.plotOptions.series.dataLabels,
    ca = F.style,
    P = r ? f(parseInt(ca.lineHeight, 10), 12) : 0,
    ca = a.series[0] || {},
    A = ca.pieYScale,
    Ta = ca.pieSliceDepth;
   d = 0 === G ? .15 * d : G;
   var I = 0,
    I =
    2 * d,
    U = f("doughnut2d" === s ? 0 : l.placevaluesinside);
   F.connectorWidth = z;
   ...
   if (1 !== r)
    for (; r--;) e.setStyle(k.pieDATALabels[r].style), p = e.getOriSize(k.pieDATALabels[r].text),
     Q = q(Q, p.width);
   ...
   if ("doughnut2d" === s || "doughnut3d" === s)
    if (s = f(l.doughnutradius, 0), r = (r = f(l.use3dlighting, 1)) ? f(l.radius3d, l["3dradius"], 50) : 100, 100 < r && (r = 100), 0 > r && (r = 0), l = 0 === s || s >= d ? d / 2 : s, a.plotOptions.pie3d.innerSize = a.plotOptions.pie.innerSize = 2 * l, 0 < r && ka && (l = parseInt(l / d * 100, 10), s = (100 - l) / 2, r = parseInt(s * r / 100, 10), l = l + $ + r + $ + 2 * (s - r) + $ + r, a.series[0] && a.series[0].data))
     for (h = a.series[0].data, a = 0, r = h.length; a <
  ...
  eiMethods: {
   ...
   centerLabel: function (a, p) {
    var c = this.jsVars.hcObj,
     ...
     s = c.canvasTop + .5 * c.canvasHeight,
     ca = k.centerLabelConfig,
     e;
    if ("object" !== typeof p) p = ca;
    else
     for (e in ca) void 0 === p[e] && (p[e] = ca[e]);
    p.label = a;
   ...
   startingAngle: function (a, p) {
    var c = this.jsVars.hcObj,
     d = c.datasets[0].plot,
     k = "pie" ===
     c.options.chart.defaultSeriesType,
     b, s = (b = c.datasets[0].startAngle) * (k ? -O : 1) + (0 > (k ? -1 : 1) * b ? 360 : 0);
    if (!isNaN(a)) {
 ...
 n("pareto2d", {
  ...
  point: function (a, p, c, d, k) {
   ...
   var b = 0,
    ...
    e = {},
    h = this.colorManager,
    r = /3d$/.test(k.chart.defaultSeriesType),
    Q = this.isBar,
    l = g(360 - d.plotfillangle, 90),
    ua = g(d.showplotborder, r ? ra : Ga) === Ga ? r ? 1 : f(d.plotborderthickness,
     1) : 0,
    B = k.chart.useRoundEdges,
    na = g(d.tooltipsepchar, ", "),
    G = g(d.plotbordercolor, h.getColor("plotBorderColor")).split($)[0],
    n = d.showplotborder == ra ? ra : g(d.plotborderalpha, d.plotfillalpha, Ca),
    x = k.xAxis,
    E = f(d.showcumulativeline, 1),
    ja = k[ta],
    y = ja.axisGridManager,
    w = ja.x,
    u = d.showtooltip != ra,
    M = [],
    z = f(d.use3dlighting, 1),
    F = k[ta].numberFormatter,
    P = f(d.showlinevalues, d.showvalues),
    A = f(d.plotborderdashed, 0),
    q, I = f(d.plotborderdashlen, 5),
    U = f(d.plotborderdashgap, 4),
    W = oa(d.xaxisname),
    V = oa(d.yaxisname),
    C = ja.numberFormatter,
    R = p,
    v, S, X, t, Y, K, m, O, aa, L, N, T, D, ha, H, J, fa, ba, la, qa, ma, ia, ga, ka, n = r ? d.showplotborder ? n : ra : n,
    G = r ? g(d.plotbordercolor, "#FFFFFF") : G;
   ...
   E && 0 < s ? (L = f(d.linedashed, 0), ma = da(g(d.linecolor, h.getColor("plotBorderColor"))), e = g(d.linealpha,
    100), N = f(d.linedashlen, 5), t = f(d.linedashgap, 4), S = f(d.linethickness, 2), D = {
    opacity: e / 100
   ...
   }, R = [R, e], ja[1] || (ja[1] = {}), ja[1].stacking100Percent = !0) : ("1" !== d.showsecondarylimits && (d.showsecondarylimits = "0"), "1" !== d.showdivlinesecondaryvalue && (d.showdivlinesecondaryvalue = "0"));
   ja[1] || (ja[1] = {});
   ja[1].stacking100Percent = !0;
   for (S = 0; S < a; S += 1) qa = M[S], T = f(qa.showlabel, d.showlabels, 1), c = oa(T ? Ja(qa.label, qa.name) : Z), m = g(qa.color, h.getPlotColor()), y.addXaxisCat(x, S, S, c, qa, {}, d, m), b += v = qa.value, t = f(qa.dashed, A), Y = g(qa.dashgap, U), K = g(qa.dashlen, I), O = g(qa.alpha, d.plotfillalpha, Ca), aa = g(qa.ratio, d.plotfillratio), T = {
     opacity: O / 100
    }, ia = g(qa.alpha, n) + Z, ma =
 ...
 n("marimekko", {
  ...
  postSeriesAddition: function (a, p) {
   var c = a[ta],
    d = 0,
    k = a.xAxis,
    b = 100 / c.marimekkoTotal,
    s = [],
    e = a.series,
    h = 0,
    r = xa({}, a.plotOptions.series.dataLabels.style),
    Q = parseInt(r.fontSize, 10),
    l = f(p.chart.plotborderthickness, 1),
    ua = a.chart.rotateValues,
    B = f(p.chart.rotatexaxispercentvalues,
     0),
    na = -.5 * l - (l % 2 + (B ? 1 : 0) + !a.chart.plotBorderWidth),
    G = B ? Q / 2 * 1.2 : 0,
    n = ua ? 270 : 0,
    x = c[0],
    E = x.stacking100Percent,
    ja = !E,
    y = c.inCanvasStyle,
    w = this.numberFormatter,
    g = p.categories && p.categories[0] && p.categories[0].category || [],
    M = 0,
    z = [],
    F, P, q, A, I, U, W, V, t, R, l = [];
   c.isXYPlot = !0;
   ...
   if (100 === M && (q && q.length) !== P)
    for (; P--;) q[P] || (q[P] = {
     p: null
    });
   M = u(M);
   if (q)
    for (I = 0, P = q.length; I < P;) {
     R = q[I];
     d += A = R && R.p || 0;
     W = 100 === M ? z[I] : A * b;
     U = h + W / 2;
     ...
     for (x = 0; x < e.length; x += 1)
      if (a.series[x].visible = !0, g = a.series[x].data[I], g._FCX = h, g._FCW = W, t = w.percentValue(g.y / A * 100), g.toolText = Ia(g.toolText, [14, 24, 25, 111, 112], {
   ...
   x = 0;
   for (P = a.xAxis.plotLines.length; x < P; x += 1)
    if (q = k.plotLines[x], q.isVline && !q._isStackSum && (c = q.value)) c -= .5, d = l[L(c)], b = l[C(c)], q.value = d + (b - d) * (c - L(c))
  },
 ...
 n("msstackedcolumn2d", {
  ...
  series: function (a, p, c) {
   ...
   if (a.dataset && 0 < a.dataset.length) {
    ...
    if (this.isDual && a.lineset && 0 < a.lineset.length)
     for (e = 0, s = a.lineset.length; e < s; e += 1, h += 1) d = a.lineset[e], r = {
  ...
  postSpaceManager: function (a, p, c) {
   ...
   if (this.isStacked && d.showStackTotal && (b = a.chart, a = (p = a.xAxis) && p.plotLines, b = c - b.marginLeft - b.marginRight, c = d.plotSpacePercent, d = d[0].stack, d = d.column && d.column.length, e = (1 - 2 * c) / d, p = b / (p.max - p.min), 50 < p * e && .1 == c))
    for (p = 50 / p, c = a && a.length,
 ...
 n("bubble", {
  ...
  point: function (a, p, c, d, b) {
   ...
   var e = !1,
    s = this.colorManager,
    ca, h, r, Q, l, ua, B, na, G, n, x, E, w, y, q, A, M = f(c.showvalues, b[ta].showValues);
   ca = f(d.bubblescale, 1);
   var z = g(d.negativecolor, "FF0000"),
    F = b.plotOptions.bubble,
    P = this.numberFormatter,
    u = p._showRegression = f(c.showregressionline, d.showregressionline, 0),
    t, I, U, W;
   ...
   if (x = c.data) {
    ...
    }), this.pointValueWatcher(b, ca, w, u && t))) : p.data.push({
     y: null
    });
    u && (c = {
     type: "line",
 ...
 n("ssgrid", {
  ...
  chart: function (a, b) {
   var c = this.containerElement,
    ...
    ua = c.offsetHeight,
    E = c.offsetWidth,
    na = this.colorManager,
    G, w, x, q, ja, y, A, u, M, z, F, P, t, C, I, U, W, V, m, R, v, S, X, K, Y, T = 0;
   w = 0;
   var c = {
     _FCconf: {
      0: {
   ...
   Q.setStyle(Y);
   for (s = 0; s < r; s += 1)
    if (x = B[s], m = l.getCleanValue(x.value), R = oa(Ja(x.label, x.name)), q = da(g(x.color, na.getPlotColor())), g(x.alpha, k.plotfillalpha, Ca), R != Z || null != m) h.push({
     value: m,
     label: R,
     color: q
    }), T += m, L += 1;
 ...
 n("renderer.bubble", {
  drawPlotBubble: function (a, p) {
   var c = this,
    ...
    s = h.dataLabels && h.dataLabels.style || {},
    ca = {
    ...
    l = c.xAxis[p.xAxis || 0],
    ua = c.yAxis[p.yAxis || 0],
    w = a.data,
    n = !1 !== (d.tooltip || {}).enabled,
    G, E, h = isNaN(+h.animation) && h.animation.duration || 1E3 * h.animation,
    x = !1 === p.visible ? "hidden" : "visible",
    d = d.plotOptions.bubble,
    g = d.zMax,
    d = d.bubbleScale,
    q = t(c.canvasHeight, c.canvasWidth) / 8,
    g = K(g),
    y, A, C,
    M, z, F, P, m, T, I, U;
   y = c.layers;
   ...
   y.datalabels ? y.datalabels.attr("class", "fusioncharts-datalabels") : y.datalabels = s.group({
    "class": "fusioncharts-datalabels"
   }, "datalables").insertAfter(A);
   ca = A.bubble = A.bubble || s.group("bubble", A);
   k.clipBubbles && !ca.attrs["clip-rect"] &&
    ca.attr({
     "clip-rect": B["clip-canvas"]
    });
   y = 0;
 ...
 n("renderer.ssgrid", {
  ...
  drawPlot: function (a) {
   var b = a.data,
    ...
    r = d.rowHeight,
    Q = d.width,
    l = d.listRowDividerAttr,
    B = l["stroke-width"],
    l = J(l.stroke),
    w = B % 2 / 2,
    E = d.textStyle,
    G = this.layers,
    G = G.dataset = G.dataset || c.group("dataset-orphan"),
    n = J(d.alternateRowColor);
   a = a.items;
   var x = 0,
    g, q, y, A;
   b && b.length || (b = []);
 ...
 Ma.prototype = {
  ...
  refreshDrawing: function () {
   return function () {
    var a =
     ...
     b = 0,
     c, d = a.length,
     k, e, s, h, f = this.slicingWallsFrontGroup,
     r = this.slicingWallsBackGroup;
    a: {
     var Q = a[0] && a[0]._conf.index,
      l, B;h = Q <= A;k = 1;
     for (c = a.length; k < c; k += 1)
      if (B = a[k]._conf.index, l = B <= A, l != h || B < Q) break a;k = 0
    }
  ...
  updateSliceConf: function (a, b) {
   var c = this.getArcPath,
    ...
    s =
    ia(k),
    h, f, r, B, l, g, n, q, G, C, x, u, t, y, m, L, M = this.cx,
    z = this.cy,
    F = this.rx,
    P = this.ry,
    O = F + (ka ? -1 : 2),
...
"Z"], a.clipOuterBackPath = this.clipPathforNoClip, this.isDoughnut && (a.clipInnerFrontPath = ["M", x, u, "A", I, U, 0, 0, 1, t, y, "v", W, "A", I, U, 0, 0, 0, x, m, "Z"], a.clipInnerBackPath = this.clipPathforNoClip)) : (a.clipOuterFrontPath = this.clipPathforNoClip, a.clipOuterBackPath = ["M", l, g, "A", F, P, 0, 0, 1, v, S, "v", W, "A", F, P, 0, 0, 0, l, R, "Z"], this.isDoughnut && (a.clipInnerFrontPath = this.clipPathforNoClip, a.clipInnerBackPath = ["M", x, u, "A", I, U, 0, 0, 1, t, y, "v", W, "A", I, U, 0, 0, 0, x, m, "Z"])) : a.clipOuterFrontPath = a.clipOuterBackPath = a.clipInnerBackPath =
    ...
    (n = this.moveCmdArr, q = this.lineCmdArr, G = this.closeCmdArr, aa = this.centerPoint, C = this.leftPoint, O = this.topPoint, K = this.rightPoint, W = this.bottomPoint, Y = this.leftDepthPoint, H = this.rightDepthPoint, h = this.leftInnerPoint, f = this.rightInnerPoint, r = this.leftInnerDepthPoint, B = this.rightInnerDepthPoint, a.clipOuterFrontPath1 = [], d != k ? (e > s ? e < A ? (d = c(M, z, l, g, this.leftX, z, F, P, 1, 0), k = c(M, z, this.leftX, z, this.rightX, z, F, P, 1, 0), S = c(M, z, this.rightX, z, v, S, F, P, 1, 0), a.clipOuterBackPath = n.concat(C, k, q, H, c(M, V, this.rightX, V,
     this.leftX, V, F, P, 0, 0), G), a.clipOuterFrontPath1 = n.concat([l, g], d, q, Y, c(M, V, this.leftX, V, l, R, F, P, 0, 0), G), a.clipOuterFrontPath = n.concat(K, S, q, [v, X], c(M, V, v, X, this.rightX, V, F, P, 0, 0), G), a.clipTopBorderPath = n.concat([l, g], d, k, S), this.isDoughnut ? (l = c(M, z, t, y, this.rightInnerX, z, I, U, 0, 0), g = c(M, z, this.rightInnerX, z, this.leftInnerX, z, I, U, 0, 0), u = c(M, z, this.leftInnerX, z, x, u, I, U, 0, 0), a.clipInnerBackPath = n.concat(f, g, q, r, c(M, V, this.leftInnerX, V, this.rightInnerX, V, I, U, 1, 0), G), a.clipInnerFrontPath = n.concat(h, u, q, [x, m], c(M, V, x, m, this.leftInnerX, V, I, U, 1, 0), G, n, [t, y], l, q, B, c(M, V, this.rightInnerX, V, t, L, I, U, 1, 0), G), a.clipTopPath = a.clipTopBorderPath.concat(q, [t, y], l, g, u, G), a.clipTopBorderPath = a.clipTopBorderPath.concat(n, [t, y], l, g, u)) : a.clipTopPath = a.clipTopBorderPath.concat(q, aa, G)) : s > A ? (d = c(M, z, l, g, this.rightX, z, F, P, 1, 0), k = c(M, z, this.rightX, z, this.leftX, z, F, P, 1, 0), S = c(M, z, this.leftX, z, v, S, F, P, 1, 0), a.clipOuterFrontPath = n.concat(K, k, q, Y, c(M, V, this.leftX, V, this.rightX, V, F, P, 0, 0), G), a.clipOuterBackPath = n.concat([l,
g], d, q, H, c(M, V, this.rightX, V, l, R, F, P, 0, 0), G, n, C, S, q, [v, X], c(M, V, v, X, this.leftX, V, F, P, 0, 0), G), a.clipTopBorderPath = n.concat([l, g], d, k, S), this.isDoughnut ? (l = c(M, z, t, y, this.leftInnerX, z, I, U, 0, 0), g = c(M, z, this.leftInnerX, z, this.rightInnerX, z, I, U, 0, 0), u = c(M, z, this.rightInnerX, z, x, u, I, U, 0, 0), a.clipInnerFrontPath = n.concat(h, g, q, B, c(M, V, this.rightInnerX, V, this.leftInnerX, V, I, U, 1, 0), G), a.clipInnerBackPath = n.concat(f, u, q, [x, m], c(M, V, x, m, this.rightInnerX, V, I, U, 1, 0), G, n, [t, y], l, q, r, c(M, V, this.leftInnerX, V, t, L,
     ...
     v, X, this.leftX, V, F, P, 0, 0), G), a.clipOuterFrontPath = n.concat([l, g], d, q, Y, c(M, V, this.leftX, V, l, R, F, P, 0, 0), G), a.clipTopBorderPath = n.concat([l, g], d, k), this.isDoughnut ? (l = c(M, z, t, y, this.leftInnerX, z, I, U, 0, 0), g = c(M, z, this.leftInnerX, z, x, u, I, U, 0, 0), a.clipInnerBackPath = n.concat([t, y], l, q, r, c(M, V, this.leftInnerX, V, t, L, I, U, 1, 0), G), a.clipInnerFrontPath = n.concat(h, g, q, [x, m], c(M, V, x, m, this.leftInnerX, V, I, U, 1, 0), G), a.clipTopPath = a.clipTopBorderPath.concat(q, [t, y], l, g, G), a.clipTopBorderPath = a.clipTopBorderPath.concat(n, [t, y], l, g)) : a.clipTopPath = a.clipTopBorderPath.concat(q, aa, G)) : (d = c(M, z, l, g, v, S, F, P, 1, 0), a.clipOuterBackPath = n.concat([l, g]), a.clipTopBorderPath = a.clipOuterBackPath.concat(d), a.clipOuterFrontPath = a.clipTopBorderPath.concat(q, [v, X], c(M, V, v, X, l, R, F, P, 0, 0), G), this.isDoughnut ? (l = c(M, z, t, y, x, u, I, U, 0, 0), a.clipInnerBackPath = n.concat([t, y]), a.clipTopPath = a.clipTopBorderPath.concat(q, [t, y], l, G), a.clipTopBorderPath = a.clipTopBorderPath.concat(n, [t, y], l), a.clipInnerFrontPath = a.clipInnerBackPath.concat(l, q, [x,
m], c(M, V, x, m, t, L, I, U, 1, 0), G)) : a.clipTopPath = a.clipTopBorderPath.concat(q, aa, G)) : (d = c(M, z, l, g, v, S, F, P, 1, 0), a.clipOuterFrontPath = n.concat([l, g]), a.clipTopBorderPath = a.clipOuterFrontPath.concat(d), a.clipOuterBackPath = a.clipTopBorderPath.concat(q, [v, X], c(M, V, v, X, l, R, F, P, 0, 0), G), this.isDoughnut ? (l = c(M, z, t, y, x, u, I, U, 0, 0), a.clipInnerFrontPath = n.concat([t, y]), a.clipTopPath = a.clipTopBorderPath.concat(q, [t, y], l, G), a.clipTopBorderPath = a.clipTopBorderPath.concat(a.clipInnerFrontPath, l), a.clipInnerBackPath = a.clipInnerFrontPath.concat(l,
     q, [x, m], c(M, V, x, m, t, L, I, U, 1, 0), G)) : a.clipTopPath = a.clipTopBorderPath.concat(q, aa, G)), d = n.concat(C, q, K), l = n.concat(O, q, W), a.clipTopPath = a.clipTopPath.concat(d, l), a.clipOuterFrontPath = a.clipOuterFrontPath.concat(d), a.clipOuterFrontPath1 = a.clipOuterFrontPath1.concat(d), a.clipOuterBackPath = a.clipOuterBackPath.concat(d), this.isDoughnut && (l = n.concat(h, q, f), a.clipInnerFrontPath = a.clipInnerFrontPath.concat(l), a.clipInnerBackPath = a.clipInnerBackPath.concat(l))) : (a.clipTopPath = a.clipOuterFrontPath = a.clipOuterBackPath = [], this.isDoughnut && (a.clipInnerFrontPath = a.clipInnerBackPath = [])), b || (a.elements.startSlice._conf.index = e, a.elements.endSlice._conf.index = s, a.elements.frontOuter._conf.index = La(s, e), a.elements.frontOuter1 && (a.elements.frontOuter1._conf.index = e, N.frontOuter1.attr({
     ...
     }), this.isDoughnut && (N.frontInner.attr({
  ...
  onPlotHover: function (a, b) {
   var c = this.pointElemStore[a]._confObject,
    d = c.thisElement,
    e = c.elements,
    h = this.colorObjs[a],
    s = h.hoverProps,
    f = b ? s.hoverColorObj : h.color,
    B = h.showBorderEffect,
    r = b ? s.borderColor : h.borderColor,
   ...
   d = ia(c.start);
   c = ia(c.end);
   (d > c ? T : 0) + c - d > A && e.frontOuter1.attr({
    fill: J(f.frontOuter),
    "stroke-width": 0
   });
  ...
  createSlice: function () {
   var a = {
    ...
    b = function (b, c) {
     ...
     if (b && "string" !== typeof b) {
      ...
      else "stroke" === d || "strokeWidth" === d || "stroke-width" === d || "dashstyle" === d || "stroke-dasharray" === d ? (h = {}, h[d] = e, f.topBorder && f.topBorder.attr(h), f.startSlice.attr(h), f.endSlice.attr(h), f.bottomBorder.attr(h)) : "fill" === d || "start" !== d && "end" !== d || (g = !0);
      else p._attr(d, e);
   ...
   return function (a, f, B, r, g, l, n, q, w, E) {
    ...
    ka ? (E = {
     ...
     fill: J(B.top),
     "stroke-width": 0
    }), r.topBorder = t[u](a.clipTopBorderPath, this.topGroup).attr({
     stroke: g,
     "stroke-width": l
    }));
    r.bottom = t[u](a.clipTopPath, this.bottomBorderGroup).attr({
     fill: J(B.bottom),
     "stroke-width": 0
    });
    ...
    r.frontOuter = t[u](a.clipOuterFrontPath,
     this.slicingWallsFrontGroup).attr({
     fill: J(B.frontOuter),
     "stroke-width": 0
    });
 ...
 n("renderer.pie3d", {
  ...
  translate: function () {
   var a = 0,
    ...
    s = c.managedPieSliceDepth,
    n = c.slicedOffset = e.slicedOffset,
    q = this.canvasWidth,
    r = this.canvasHeight,
    Q = [this.canvasLeft + .5 * q, this.canvasTop + .5 * r - .5 * s],
    l, A, C, m, G, b = c.data,
    K, x = t(q, r),
    O, aa, y, H = d.distance,
    ha = c.pieYScale,
  ...
  drawPlotPie3d: function (a, b) {
   ...
   var c = this,
    ...
    n = c.datasets[0],
    s = s.series.dataLabels,
    l = B.dataLabels.style,
    B = f(a.moveDuration, B.animation.duration),
    q = c.paper,
    t = h.tooltip || {},
    t = t && !1 !== t.enabled,
    u = n.slicedOffset,
    ...
    K = b.showBorderEffect,
    M = e.length,
    z = h.chart,
    h = z.usePerPointLabelColor,
    z = z.textDirection,
    F = {
   ...
   for ($ = -1; ++$ < M;) v = e[$], l = v.y, S = v.displayValue, F = v.sliced, ha = v.shapeArgs, aa = v.centerAngle, D = v.toolText, H = (X = !!v.link) || T || !v.doNotSlice, null === l || void 0 === l || (R = d[$]) || (b.data[$].plot = R = d[$] = {
    ...
    transform: "t" + R.slicedX + "," + R.slicedY,
    ishot: H,
    cursor: X ? "pointer" : ""
  ...
  plotDragMove: function (a, b, c, d, e) {
   ...
   h.options.series[0].enableRotation && !b.singletonCase && (c = Pa.call(e, c, d, b.pieCenter, b.chartPosition, a.pieYScale), b.isRotating || (a.dragStartAngle !== c && (b.isRotating = !0), ea.raiseEvent("rotationStart", {
    startingAngle: ia(a.startAngle, !0)
   }, h.logic.chartInstance)), d = c - a.dragStartAngle, a.dragStartAngle = c, b.moveDuration = 0, a._lastAngle += 180 * d / H, c = (new Date).getTime(), !a._lastTime || a._lastTime + b.timerThreshold < c) && (a._lastTime || h.rotate(), b.timerId = setTimeout(function () {
  ...
  animate: function (a, b) {
   ...
   if (r.datasets[0].alphaAnimation) r.layers.dataset.attr({
     opacity: 0
    }),
    r.layers.dataset.animate({
     opacity: 1
    }, b, "ease-in", function () {
     r.disposed || r.disposing || r.placeDataLabels(!1, a)
    });
   else
    for (c = 0; c < h; c++) f = a[c], B = f.graphic, g = f.shapeArgs, f = 2 * H, B && (B.attr({
     start: f,
     end: f
  ...
  placeDataLabels: function () {
   var a = function (a, b) {
    ...
    e = [1, 1, -1, -1];
   return function (g, n) {
    var m = this.datasets[0],
     L = this.smartLabel,
     r = this.options.plotOptions.series.dataLabels,
     Q = r.style,
     l = f(C(parseFloat(Q.lineHeight)), 12),
     K = Ja(r.placeInside, !1),
     N = r.skipOverlapLabels,
     aa = r.manageLabelOverflow,
     G = r.connectorPadding,
     O = r.connectorWidth,
     x, H, $ = 0 < r.distance,
     y = m.center,
     D = y[1],
     ...
     z = y[4],
     F = [[], [], [], []],
     P, Z, fa, I = this.canvasLeft,
     U = this.canvasTop,
     W = this.canvasWidth,
     V, ba, R, v, S, X, da, Y, ma, la, va, ia = m.labelsRadius,
     ga = u(100 * m.labelsRadiusY) / 100,
     ka = m.labelFontSize,
     Ba = ka,
     Fa = Ba / 2,
     G = [G, G, -G, -G],
     oa = m.maxLabels,
     ra = m.isSmartLineSlanted,
     sa = m.enableSmartLabels,
     ea, m = m.pieSliceDepth / 2;
    g || L.setStyle(Q);
    if (1 == n.length) v = n[0], ea = v.dataLabel, v.slicedTranslation = [I, U], ea && (ea.attr({
     ...
     for (fa = K = 4; fa--;) {
      if (N && (v = F[fa].length - oa, 0 < v))
       for (F[fa].sort(a), Z = F[fa].splice(0, v), ba = 0, R = Z.length; ba < R; ba += 1) v = Z[ba].point, v.dataLabel.attr({
        visibility: "hidden"
     ...
     for (L.setStyle(Q); K--;) {
      ...
      for (fa = ba.length - 1; 0 <= fa; --fa, R += Ba) v = ba[fa].point, va = ba[fa].angle, S = v.sliced, ea = v.dataLabel, H = ha(ga * E(va)), H < Q ? H = Q : H > R && (H = R), Q = H + Ba, Y = (H + ba[fa].oriY) / 2, H = J + e[K] * ia * w(B.asin(Y / ga)), Y *= d[K], Y += D, ma = D + z * E(va), X = J + M * w(va), (2 > K && H < X || 1 < K && H > X) && (H = X), da = H + G[K], la = Y + Fa - 2, x = da + G[K], ea.x = x, ea._x = x, aa && (V = 1 < K ? x - this.canvasLeft : this.canvasLeft +
       ...
       x: x,
       y: Y
      }), $ && O && sa && (x = v.connector, v.connectorPath = H = ["M", X, ma, "L", ra ? H : X, Y, da, Y], x ? (x.attr({
       path: H
      }), x.attr("visibility", h)) : v.connector = x = this.paper.path(H).attr({
       "stroke-width": O,
 ...
 n("renderer.pie", {
  ...
  drawPlotPie: function (a, b) {
   var c = this,
    ...
    K = B.tooltip || {},
    K = K && !1 !== K.enabled,
    x = ((b.startAngle *= -A / 180) || 0) % T,
    H = q.slicedOffset,
    L = b.valueTotal,
    y = T / L,
    N = c.canvasLeft + .5 * c.canvasWidth,
    O = c.canvasTop + .5 * c.canvasHeight,
    M = .5 * q.size,
    q = .5 * (q.innerSize || 0),
    z = c.plotDragMove,
    F = c.plotDragStart,
    ...
    aa = c.plotRollOver,
    ha = c.plotRollOut,
    I = !!c.datasets[0].enableRotation,
    U = e.length,
    W = B.chart,
    B = W.usePerPointLabelColor,
    W = W.textDirection,
    V = g.centerLabelConfig,
    $ = V.label,
    R = {
    ...
    v, S, X, D, Y, fa, ba, Z, da, ma, la = a.shadowGroup,
    ea, Ba, ia, ka, Fa, oa = function (a) {
     return function () {
      c.legendClick(a, !0, !1)
     }
    },
   ...
   for (ea = U; ea--;) S = e[ea], R = S.y, X = S.displayValue, Y = S.sliced, m = S.toolText, fa = (D = !!S.link) || I || !S.doNotSlice, null !== R && void 0 !== R && (v = S.color.FCcolor, v.r = M, v.cx = N, v.cy = O, S.rolloverProperties && (v = S.rolloverProperties.color.FCcolor, v.r = M, v.cx = N, v.cy = O), da = Z, Z -= u.singletonCase ? T : R * y, ba = .5 * (Z + da), r ? ka = Fa = x : (ka = Z, Fa = da), (v = d[ea]) || (b.data[ea].plot = v = d[ea] = {
    ...
    redrawDataLabels: c,
    transform: v.sliced ? v.slicedTranslation : ""
   }, r, "easeIn", sa), Ba = v.graphic.animate(ia)) : v.graphic.attr({
    transform: v.sliced ? v.slicedTranslation : ""
   }));
   $ && q && c.drawDoughnutCenterLabel($, N, O, 2 * q, 2 * q, V, !0);
   g.lastCenterLabelConfig = V;
   r ? g.doughnutCenterLabel &&
    g.doughnutCenterLabel.attr({
     "fill-opacity": 0
    }).animate(ga.animation({
     "fill-opacity": 100
    }, 100).delay(100 < r ? r - 100 : 0)) : c.placeDataLabels(!1, d, a)
  },
  rotate: function (a, b) {
   var c = a.items,
    d = a.data,
    ...
    h = e.slicedOffset,
    f = T / b.valueTotal,
    B = this.canvasLeft + .5 * this.canvasWidth,
    g = this.canvasTop + .5 * this.canvasHeight,
    r = .5 * e.size,
    e = .5 * (e.innerSize || 0),
    n, l, q, m, t;
   q = (b.startAngle || 0) % T;
...
FusionCharts.register("module", ["private", "modules.renderer.js-zoomline", function () {
 var Da = this,
  pa = Da.hcLib,
  ia = Da.window,
  La = /msie/i.test(ia.navigator.userAgent) && !ia.opera,
  Pa = pa.chartAPI,
  Ma = pa.chartAPI,
  ea = pa.extend2,
  D = pa.raiseEvent,
  ...
  m = pa.pluckNumber,
  Ka = pa.getFirstColor,
  Z = pa.graphics.convertColor,
  Xa = pa.bindSelectionEvent,
  g = pa.createTrendLine,
  wa = pa.parseUnsafeString,
  Ia = pa.regescape,
  f = pa.Raphael,
  Ja = pa.hasTouch,
  Ua = pa.getMouseCoordinate,
  oa = pa.FC_CONFIG_STRING,
  ta = "rgba(192,192,192," + (La ? .002 :
   1E-6) + ")",
  xa = ia.Math,
  Ea = xa.ceil,
  J = xa.floor,
 ...
 Pa("zoomline", {
  ...
  preSeriesAddition: function () {
   var b = this.dataObj,
    ...
    f = h[oa],
    g = this.smartLabel,
    w = m(e.compactdatamode, 0),
    aa = ga(e.dataseparator, "|"),
    u = m(e.showlabels, 1),
    t = e.labeldisplay && e.labeldisplay.toLowerCase(),
    q = u && m(e.labelheight),
    ha = "rotate" === t ? 270 : m(e.rotatelabels, 1) ? 270 : 0,
    H = h.xAxis.labels.style,
    C = ya(H.lineHeight),
    L = h.chart.labelPadding = m(e.labelpadding, .2 * C) + h.chart.plotBorderWidth,
    K, N, O, A = 0,
    D = -1,
    T, J, Z;
   0 > q && (q = void 0);
  ...
  series: function () {
   var b = this.dataObj,
    ...
    u = m(e.yaxismaxvalue),
    t = m(e.yaxisminvalue),
    q = m(e.forceyaxislimits, 0),
    ha = m(e.compactdatamode, 0),
    H = ga(e.dataseparator, "|"),
    C = Ia(e.indecimalseparator),
    L = Ia(e.inthousandseparator),
    K = m(e.drawanchors, e.showanchors, 1),
    N = !!m(e.showlegend,
     1),
    O, A, D, T, J, Z = Infinity,
    da = -Infinity,
    ba;
   ...
   if (h && h.length && J) {
    ...
    for (t = h.length; u < t; u++) {
     ...
     if (ha) {
      if (!q)
       for (; ba--;) A = ya(T[ba]), isNaN(A) && (A = void 0), A > da && (da = A), A <= Z && (Z = A), T[ba] = A
     }
     else
      for (; ba--;) A = T[ba] && T[ba].value ||
 ...
 Ma("renderer.zoomline", {
  ...
  activatePin: function (b) {
   var e =
    ...
    g = this.pinButton;
   if (g && e.pinned ^ (b = !!b)) return b || this.pinRangePixels(), D("zoomModeChanged", {
    pinModeActive: b
  ...
  pinRangePixels: function (b, e) {
   var f = this.paper,
    ...
    m = this.xlabels.data,
    w = this._zoominfo,
    aa = this.layers.zoompin,
    u = g.pinrect,
    t = g["clip-pinrect"],
    q = this._pingrouptransform,
    J = this.plots,
    H = e - b,
    C, L;
   if (w && aa && u) {
...
b.canvasTop, b._visw + 2 * u.overFlowingMarkerWidth, b.canvasHeight]), Z = C.scroll || (C.scroll = e.group("scroll").insertAfter(C.layerAboveDataset)), b.xlabels = [], b.xlabels.show = O.show, b.xlabels.height = O.labelHeight, b.xlabels.wrap = O.wrap, b.xlabels.rotate = O.rotate, b.xlabels.data = O.data || [], b.xlabels.parsed = [], b.xlabels.css = O.css, b.xlabels.group = e.group("zoomline-plot-xlabels", C.datalabels), C.datalabels.transform(["T", ga, g + w + u.scrollHeight + u.labelPadding]), b._lcmd = O.rotate ? "y" : "x", N && (N = f.crispBound(0, g - ia, 0, w,
     ...
     var e = ga + b + this.__pindragdelta,
      h = this.__pinboundleft,
      g = this.__pinboundright,
      q = this.data("cliprect").slice(0);
     e < h ? e = h : e > g && (e = g);
     T.transform(["T", e, ia]);
     ...
     tooltip: D && u.btnSwitchToPinModeTooltext || ""
    })), t++, N = f.crispBound(h - t, g + w + t, m + t + t, u.scrollHeight, t), t--, K.zoomscroller = e.scroller(N.x + (q && -1 || t % 2), N.y - (q && 4 || 2), N.width - (!q && 2 || 0), N.height, !0, {
     ...
     tooltip: D && u.btnZoomOutTooltext || ""
    })[A && "show" || "hide"](), b.resetButton = L.add("resetIcon", function () {
     b.resetZoom()
    }, {
     tooltip: D && u.btnResetChartTooltext || ""
    }).hide(), N = b.resetButton.attr("fill"), N[2] = "rgba(255,255,255,0)", b.resetButton.attr("fill", [N[0], N[1], N[2], N[3]]), H &&
  ...
  updatePlotZoomline: function (b, e) {
   var f = this.paper,
    ...
    u = w.group,
    t = this.plots,
    q = this.options.chart.textDirection,
    D, H, C, L, K, N, O, A;
   !e && (e = this._zoominfo);
   C = e.oppp;
   L = e.vdl = e.dei - e.dsi;
   ...
   A = e.ppc = N * C * m;
   if (g > O)
    for (C = O, O = g; C < O; C++)(D = w[C]) && D.show() || (w[C] = f.text(0, 0, "", u).css(aa).attr({
     direction: q
    }));
   else
    for (C = g, O += 1; C < O; C++) w[C].hide();
  ...
  drawPlotZoomlineGraphics: function (b, e, f, g, m, w, D) {
   var u = this.smartLabel,
    t = this.paper,
    q = this.numberFormatter,
    J = this.options.chart,
    H = J.useCrossline,
    C = J.showPeakData,
    L = J.maxPeakDataLimit,
    K = J.minPeakDataLimit,
    N = [],
    O = !b.cnd,
    A = b.ddei,
    Z = b.clen,
 ...
 za = function (b, e) {
  var f = b.paper,
   ...
   D = this.top = b.canvasTop,
   u = this.height =
   b.canvasHeight,
   t = this._visout = b._visout,
   q = this.plots = b.plots,
   J = b.layers.dataset,
   H, C = e.labelstyle,
   L = e.valuestyle;
  H = this.group = f.group("crossline-labels", J).attr({
   transform: ["T", m, b._ymin]
  });
 ...
 za.prototype.updateLabels = function () {
  ...
  e && e.forEach(function (e, C) {
   ...
   e.attr({
    x: Na(0, Oa(D, g)),
    y: L,
    "text-anchor": w <= O && "start" || w + O >= g && "end" || "middle"
   })
  });
  b.positionLabel &&
   b.positionLabel.attr({
    x: w + b.left,
    text: b.getPositionLabel(m)
   })
 };
